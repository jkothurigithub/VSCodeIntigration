      ...
      *
       01  WS-FIELDS.
           ...
           05  CAPPGM2                 PIC X(8)  VALUE 'CAPPGM2'.
      *
      ...
      *****************************************************************
       000-MAIN.
           ...
           DISPLAY 'CAPPGM1 STARTED DATE = ' CURRENT-MONTH '/'
      ...
      * TODO this is a task tag
           ...
           ACCEPT CURRENT-DATE FROM DATE.
           ACCEPT CURRENT-TIME FROM TIME.
           DISPLAY 'CAPPGM1 STOPPED DATE = ' CURRENT-MONTH '/'
                  CURRENT-DAY '/' CURRENT-YEAR  '  (mm/dd/yy)'.
           DISPLAY '             TIME = ' CURRENT-HOUR ':'
                  CURRENT-MINUTE ':' CURRENT-SECOND.
           GOBACK .
       ...
       200-PROCESS-UPDATE-TRAN.
           ...
           ELSE
      *
      *        Subroutine CAPPGM2 will apply an update to a customer record
      *
               CALL CAPPGM2 USING CUST-REC, TRANSACTION-RECORD,
